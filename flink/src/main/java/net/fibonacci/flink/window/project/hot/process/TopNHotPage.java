 ...
 * @Description:
 */
public class TopNHotPage extends KeyedProcessFunction<Long, ResultBean, String> {
    ...
    @Override
    public void processElement(ResultBean urlView,
                               Context context,
                               Collector<String> out) throws Exception {

        urlState.put(urlView.getPath(),urlView.getCount());

        // 注册定时器
        context.timerService().registerEventTimeTimer(urlView.getWindowTime() + 1);
